...
def populate():
    ...
    hooks_open_t = hooks_table.find({"hook": 2})
    opens_opens_t = opens_table.find({"opens": 2})
    ...
    hooks_open_th = hooks_table.find({"hook": 3})
    opens_opens_th = opens_table.find({"opens": 3})
    ...
    hooks_open_f = hooks_table.find({"hook": 4})
    opens_opens_f = opens_table.find({"opens": 4})
    ...
    hooks_open_fi = hooks_table.find({"hook": 5})
    opens_opens_fi = opens_table.find({"opens": 5})
    ...
    hooks_open_s = hooks_table.find({"hook": 6})
    opens_opens_s = opens_table.find({"opens": 6})
